     ...
     this.store.get("token").then(token=>{
      if(token!=null){
       // http://ajit.sn/parrainage/ws/serviceAjoutParrainage/?
        ...
        let url = this.URL.URL+"serviceAjoutParrainage/?token="+token+"&entite="+encodeURI(this.datauser.controls['entite'].value)+"&nfcid="+this.datauser.controls['idnfc'].value;
        url += "&piece="+encodeURI(this.datauser.controls['piece'].value)+"&prenom="+encodeURI(this.datauser.controls['prenom'].value);
        ...
        url += "&commune="+encodeURI(this.datauser.controls['commune'].value)+"&adresse="+encodeURI(this.datauser.controls['adresse'].value);
        url += "&section="+encodeURI(this.datauser.controls['section'].value)+"&email="+encodeURI(this.datauser.controls['mail'].value);
        url += "&genre="+this.datauser.controls['genre'].value+"&datenaissance="+encodeURI(datenaiss);
        url += "&profession="+encodeURI(this.datauser.controls['profession'].value)+"&timestamp="+encodeURI(this.datauser.controls['timestamp'].value);
